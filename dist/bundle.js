...
// axios.get('http://www.matapi.se/foodstuff/44')
...
window.call = __WEBPACK_IMPORTED_MODULE_0_axios___default()({
  method: 'get',
  url: 'http://www.matapi.se/foodstuff/44',
  headers:{
...
// xhttp.open("GET", "http://www.matapi.se/foodstuff/44", true);
